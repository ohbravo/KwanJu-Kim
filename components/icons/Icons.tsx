...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904a4.5 4.5 0 0 1 4.374 0M8.25 12a3.75 3.75 0 1 1 7.5 0a3.75 3.75 0 0 1-7.5 0ZM18.75 12a6.375 6.375 0 1 1-12.75 0a6.375 6.375 0 0 1 12.75 0ZM21 12c0 4.969-4.031 9-9 9s-9-4.031-9-9 4.031-9 9-9 9 4.031 9 9Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V19.5M8.25 19.5V18M15.75 19.5V18M12 3V4.5M8.25 4.5V6M15.75 4.5V6M3 12H4.5M19.5 12H21" />
  </svg>
);
